...
const DynamicForm = () => {
  ...
  //Starting form field without any value
  ...
  //useEffect to handle client-side initialization
  useEffect(() => {
    setIsMounted(true);
  }, []);

  // Handleing input change
  const handleInputChange = (index, event) => {
    ...
    // Clear error when type on the field
    if (isSubmitted) {
  ...
  const handleSubmit = (e) => {
    ...
    if (validateForm()) {
      ...
      // Saveing the current form fields 
